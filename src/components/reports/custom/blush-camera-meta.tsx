...
/**
 * BlushCameraMetaReport — Ecommerce Meta Ads report with sparklines, funnel,
...
} from './_blush-camera-meta/ReportHeader';
import ReportChart from './_blush-camera-meta/ReportChart';
import BreakdownTable from './_blush-camera-meta/BreakdownTable';
import ReportNotesTimeline from './_blush-camera-meta/ReportNotesTimeline';
import {
  SparklineKpiCard,
...
export default function BlushCameraMetaReport({
  client,
  mode,
}: {
