...
/**
 * Branched from LeadGenMetaReport.tsx on 2026-04-20.
...
/**
 * ChattanoogaSkydivingMetaReport — Lead generation report for Meta Ads clients.
 *
...
import { SparklineKpiCard } from './_chattanooga-skydiving-meta/shared';
import { ReportingClient } from './_chattanooga-skydiving-meta/types';
...
export default function ChattanoogaSkydivingMetaReport({ client, mode }: { client: ReportingClient; mode: 'internal' | 'public' }) {
