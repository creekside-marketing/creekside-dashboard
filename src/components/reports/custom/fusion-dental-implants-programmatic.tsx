...
/**
 * FusionDentalImplantsProgrammaticReport — Upgraded Lead Gen report for Google Ads clients.
 *
...
import {
  SparklineKpiCard,
  DemographicChart,
} from './_fusion-dental-implants-programmatic/shared';
import { useGoogleAdsData } from '@/hooks/useGoogleAdsData';
import { ReportingClient } from './_fusion-dental-implants-programmatic/types';
...
export default function FusionDentalImplantsProgrammaticReport({
  client,
  mode,
}: {
