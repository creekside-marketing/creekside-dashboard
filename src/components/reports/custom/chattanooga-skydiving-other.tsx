 ...
 *   npm run branch-report -- "<client>" other --force
 */
/**
...
/**
 * ChattanoogaSkydivingOtherReport — Upgraded Lead Gen report for Google Ads clients.
 *
...
import {
  SparklineKpiCard,
  DemographicChart,
} from './_chattanooga-skydiving-other/shared';
import { useGoogleAdsData } from '@/hooks/useGoogleAdsData';
import { ReportingClient } from './_chattanooga-skydiving-other/types';
...
export default function ChattanoogaSkydivingOtherReport({
  client,
  mode,
}: {
