...
/**
 * Branched from LeadGenGoogleReport.tsx on 2026-04-28.
 * Standalone per-client fork — upstream template changes do NOT auto-propagate.
 * To re-sync from the latest template, re-run:
 *   npm run branch-report -- "Perfect Parking" google --force
 *
 * Customizations applied:
 * - All numeric values (KPI cards, table cells, row numbers) rendered in yellow (text-yellow-400)
 */
...
import {
  SparklineKpiCard,
  DemographicChart,
} from './_perfect-parking-google/shared';
import { useGoogleAdsData } from '@/hooks/useGoogleAdsData';
import { ReportingClient } from './_perfect-parking-google/types';
...
export default function PerfectParkingGoogleReport({
  client,
  mode,
}: {
